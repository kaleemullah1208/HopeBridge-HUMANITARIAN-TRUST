...
export const INITIAL_AID_REQUESTS = [
  {
    id: "AID-2026-1001",
    applicantId: "usr-ben-01",
    fullName: "Muhammad Aslam",
    email: "aslam.family@gmail.com",
    phone: "+92 312 9988771",
    cnic: "35202-1234567-1",
    city: "Lahore",
    address: "House 14, Street 3, Chungi Amar Sidhu, Lahore",
    category: "Medical Aid",
    amountNeeded: 65000,
    description: "Urgent kidney dialysis and monthly prescription medications for elderly mother. Hospital prescription bills attached.",
    documentUrl: "https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&w=600&q=80",
    status: "Approved",
    adminNotes: "Prescriptions and hospital admission slip verified with Jinnah Hospital Nephrology ward. Approved for fund disbursement.",
    createdAt: "2026-08-28T10:30:00Z",
    disbursedAt: "2026-08-30T15:00:00Z"
  },
  {
    id: "AID-2026-1002",
    applicantId: "guest",
    fullName: "Kalsoom Bibi (Widow)",
    email: "kalsoom.widow@yahoo.com",
    phone: "+92 344 5566778",
    cnic: "42101-7654321-2",
    city: "Karachi",
    address: "Sector 5-J, Orangi Town, Karachi",
    category: "Food Ration",
    amountNeeded: 18000,
    description: "Support for 2 months of basic kitchen dry rations (flour, rice, oil, pulses) for family of 4 orphaned children.",
    documentUrl: "",
    status: "Under Review",
    adminNotes: "Local area coordinator assigned to visit Orangi Town for physical household assessment.",
  ...
  },
  {
    ...
    email: "rashid.m.education@outlook.com",
    phone: "+92 333 1122339",
    cnic: "37405-9988112-3",
    city: "Rawalpindi",
    address: "Mohallah Waris Khan, Rawalpindi",
    category: "Education / School Fee",
    amountNeeded: 35000,
    description: "Annual school tuition fee and books assistance for two meritorious daughters studying in 8th and 10th grade.",
    documentUrl: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?auto=format&fit=crop&w=600&q=80",
    status: "Pending",
    adminNotes: "",
  ...
  },
  {
    id: "AID-2026-1004",
    applicantId: "guest",
    fullName: "Gulzar Ahmed",
    email: "gulzar.flood@hotmail.com",
    phone: "+92 301 4455667",
    cnic: "45302-8811223-5",
    city: "Dadu, Sindh",
    address: "Village Mehar, Tehsil Mehar, District Dadu",
    category: "Emergency Financial Relief",
    amountNeeded: 50000,
    description: "Mud-house roof collapsed due to heavy flash floods. Need immediate financial assistance to reconstruct emergency shelter before winter.",
    documentUrl: "https://images.unsplash.com/photo-1547683905-f686c993aae5?auto=format&fit=crop&w=600&q=80",
    status: "Pending",
    adminNotes: "",
  ...
  },
  {
    id: "AID-2026-1005",
    applicantId: "guest",
    fullName: "Tariq Pervaiz",
    email: "fake.application@invalid.com",
    phone: "+92 300 0009999",
    cnic: "00000-0000000-0",
    city: "Peshawar",
    address: "Unknown",
    category: "Emergency Financial Relief",
    amountNeeded: 250000,
    description: "Unsubstantiated request with fake national identification.",
    documentUrl: "",
    status: "Rejected",
    adminNotes: "CNIC verification failed. Duplicate submission with invalid phone.",
